            ...
            <RevealItem key={cert.title}>
              {cert.url ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group relative h-full overflow-hidden rounded-4xl border border-border bg-surface/50 p-7 backdrop-blur-sm transition-all duration-500 hover:border-primary/50 hover:shadow-[0_0_60px_-20px_rgb(var(--glow))] block"
                >
